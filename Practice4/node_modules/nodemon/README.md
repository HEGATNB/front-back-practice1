...
```bash
nodemon ./server.js.js localhost 8080
```
...
```bash
nodemon --inspect ./server.js.js 80
```
...
```bash
nodemon --watch app --watch libs app/server.js.js
```
...
```bash
nodemon --delay 10 server.js.js
```

For more precision, milliseconds can be specified.  Either as a float:

```bash
nodemon --delay 2.5 server.js.js
```

Or using the time specifier (ms):

```bash
nodemon --delay 2500ms server.js.js
```
...
```bash
nodemon --signal SIGHUP server.js.js
```
